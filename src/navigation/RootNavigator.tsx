...
const OwnerTabs = () => {
    ...
    return (
        ...
        >
            ...
            <OwnerTab.Screen name="OwnerSales" component={OwnerSalesScreen} options={{ tabBarLabel: 'Sales' }} />
            <OwnerTab.Screen name="OwnerProfile" component={OwnerProfileScreen} options={{ tabBarLabel: 'Profile' }} />
        </OwnerTab.Navigator>
    );
};
